...
public class SqlMapBase {
	...
	public List<?> querySelect(Class cls, Session session, String path, String name, Map map ){
	...
	public List<?> queryList(Class cls, Session session, String path, String name, Map map ){
	...
	public DataSet queryListNative(Session session, String path, String name, Map map ){
	...
	public int queryUpdate(Session session, String path, String name, Map map ){
	...
	public int queryUpdateNative(Session session, String path, String name, Map map ){
